...
[
  ...
  # instantiation.
  {"lib/fathom/bench.ex", :missing_range, 848},
  {"lib/fathom/bench.ex", :missing_range, 911},
  {"lib/fathom/bench.ex", :missing_range, 1003},
  {"lib/fathom/bench.ex", :extra_range, 1061},
  ...
  {"lib/fathom/migrator.ex", :missing_range, 568},
