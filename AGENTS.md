...
**Docs index:** [`docs/README.md`](docs/README.md) maps the per-subsystem how-it-works stories (single-writer, warm-standby, rebalancing, migration), the design plans, the benchmark plans, the runbooks, and the run reports.
